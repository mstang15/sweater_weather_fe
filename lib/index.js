...
function getFavorites(){
  var get_fav_url = url + `api/v1/favorites?api_key=sY61IG-4H3RvdgC_AC0WVQ`;
...
function displayFavorites(favorites){
  ...
  $.each(favoritesDisplay, function(index, favorite ) {
    x = document.getElementById(`favorite-${index + 1}`);
...
//   var newFavorite = document.getElementById('current-city').innerHTML
//   var post_fav_url = url + `api/v1/favorites?location=${newFavorite}&api_key=sY61IG-4H3RvdgC_AC0WVQ`;
//   var requestPosFav = new XMLHttpRequest();
//   requestPosFav.open('POST',post_fav_url);
//   requestPosFav.onload = function(){
//     // var favorite = JSON.parse(this.responseText);
//     getFavorites();
//   };
//   requestPosFav.send();
// }
...
// const postFavorite = () => {
//   var post_fav_url = url + 'api/v1/favorites'
//   fetch(post_fav_url, {
//      method: 'POST',
//      headers: { 'Content-Type': 'application/json' },
//      body: JSON.stringify({
//        "location": $("#current-city").val(),
//        "api_key": 'sY61IG-4H3RvdgC_AC0WVQ',
//      })
//    })
...
// }
//
// $('#add-favorite').on('click', postFavorite());
